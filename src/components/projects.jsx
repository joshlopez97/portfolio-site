      ...
      <div>
        <div className="external-link-icon-holder">
          <a className={(!!info.site ? "project-link" : "hidden")} href={info.site}>
            <svg className="project-link-icon website" xmlns="http://www.w3.org/2000/svg" role="img"
                 x="0px" y="0px"
                 viewBox="0 0 15 15">
              <g>
		...
		C13.928,8.704,13.762,9.377,13.502,10z M11.99,7c-0.027-0.697-0.112-1.368-0.246-2h1.758c0.26,0.623,0.426,1.296,0.479,2H11.99z"/>
          ...
          <a className={(!!info.github ? "project-link" : "hidden")} href={info.github}>
            <svg className="project-link-icon github" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 438.549 438.549">
              <path
